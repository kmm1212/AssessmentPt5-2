...
let hi = prompt("What is your zipcode?");
...
function canWeDeliverTwo (zipCode){
    ...
    return console.log("You're not eligible for delivery")
}

let hitwo = prompt("What is your zipcode?");

let z = parseInt(hitwo);

console.log(canWeDeliverTwo(z))
